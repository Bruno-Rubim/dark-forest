...
export const sprites = {
    ...
    texture_sheet_shadow_tall_block: new Sprite("texture_sheet_shadow_tall_block"),
    texture_sheet_shadow_top_block: new Sprite("texture_sheet_shadow_top_block"),
    texture_sheet_shadow_full_block: new Sprite("texture_sheet_shadow_full_block"),
    ...
    texture_sheet_sewer_rock_ceiling: new Sprite("texture_sheet_sewer_rock_ceiling"),
